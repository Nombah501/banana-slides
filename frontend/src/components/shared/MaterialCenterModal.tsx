...
const i18nDict = {
  ...
  ru: {
    mc: {
      ...
      count: '{{count}} материалов',
      empty: 'Материалы отсутствуют',
      selected: 'Выбрано: {{count}}',
      filterAll: 'Все материалы',
      filterNone: 'Не связанные с проектом',
      moreProjects: '+ Ещё проекты…',
      preview: 'Просмотреть',
      remove: 'Удалить',
      closePreview: 'Закрыть предпросмотр',
      emptyHint: 'Загрузите изображения или создайте материалы с помощью генератора',
      msg: {
        loadErr: 'Не удалось загрузить материалы',
        badFormat: 'Неподдерживаемый формат изображения',
        uploaded: 'Материал успешно загружен',
        uploadErr: 'Не удалось загрузить материал',
        noId: 'Невозможно удалить: отсутствует идентификатор материала',
        deleted: 'Материал удалён',
        deleteErr: 'Не удалось удалить материал',
        downloaded: 'Скачивание завершено',
        downloadErr: 'Не удалось скачать материалы',
        zipped: 'Упаковано {{count}} материалов',
        zipErr: 'Не удалось скачать материалы пакетом',
        pickFirst: 'Сначала выберите материалы для скачивания',
      },
    },
  },
};
