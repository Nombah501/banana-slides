...
const materialGeneratorI18n = {
  ...
  ru: {
    material: {
      title: 'Инструменты для материалов',
      saveToLibraryNote: 'Все результаты обработки сохраняются в библиотеку материалов как новые материалы. Исходное изображение не изменяется.',
      generatedResult: 'Результат',
      generatedPreview: 'Результат обработки будет отображён здесь',
      sourceImage: 'Исходное изображение',
      sourceImageHint: 'Для редактирования всего изображения, выделенной области и интеллектуального удаления сначала выберите исходное изображение.',
      referenceImages: 'Референсные изображения (необязательно)',
      mainReference: 'Основное референсное изображение',
      extraReference: 'Дополнительные референсные изображения',
      clickToUpload: 'Загрузить',
      selectFromLibrary: 'Выбрать из библиотеки',
      promptLabel: 'Инструкция',
      promptPlaceholderGenerate: 'Например: сине-фиолетовый градиентный фон с геометрическими фигурами и технологичными линиями для титульной страницы в технологичном стиле...',
      promptPlaceholderEdit: 'Например: придайте главному визуальному образу фактуру серебристого металла, сделайте общий вид более премиальным, сохранив основную композицию...',
      promptPlaceholderRegion: 'Например: придайте кнопке в выделенной области стиль стекломорфизма и добавьте мягкие блики...',
      promptPlaceholderErase: 'Необязательно: укажите, чем заполнить удалённую область, например «чистой текстурой белой столешницы»',
      aspectRatioLabel: 'Соотношение сторон',
      toolModeLabel: 'Режим инструмента',
      toolGenerate: 'Сгенерировать новый материал',
      toolEditFull: 'Отредактировать всё изображение',
      toolRegionEdit: 'Отредактировать область',
      toolEraseRegion: 'Выполнить интеллектуальное удаление',
      runTool: 'Запустить инструмент',
      toolGenerateDesc: 'Сгенерировать новый материал по инструкции или референсным изображениям',
      toolEditFullDesc: 'Перерисовать всё исходное изображение',
      toolRegionEditDesc: 'Изменить только выбранную область',
      toolEraseRegionDesc: 'Удалить содержимое выбранной области и восстановить фон',
      selectionLabel: 'Выделение',
      selectionHint: 'Включите режим выделения, затем протяните рамку на изображении, чтобы выбрать нужную область.',
      selectionReady: 'Выбрана область размером {{width}} × {{height}} px',
      selectionEmpty: 'Область не выбрана',
      startSelection: 'Начать выделение',
      stopSelection: 'Завершить выделение',
      applyModeLabel: 'Способ применения результата для области',
      applyOverlay: 'Наложить результат только на выбранную область',
      applyReplaceFull: 'Заменить всё изображение сгенерированным результатом',
      useResultAsSource: 'Использовать результат как новое исходное изображение',
      clearResult: 'Очистить результат',
      enterFullscreen: 'Развернуть на весь экран',
      exitFullscreen: 'Выйти из полноэкранного режима',
      messages: {
        enterPrompt: 'Введите инструкцию',
        chooseSource: 'Сначала выберите исходное изображение',
        chooseSelection: 'Сначала выделите область',
        materialAdded: 'Добавлено материалов: {{count}}',
        sourceLoaded: 'Исходное изображение загружено',
        generateSuccess: 'Материал успешно обработан и сохранён в библиотеку проекта',
        generateSuccessGlobal: 'Материал успешно обработан и сохранён в глобальную библиотеку',
        generateComplete: 'Обработка завершена, но URL изображения результата не возвращён',
        generateFailed: 'Не удалось обработать материал',
        generateTimeout: 'Истекло время ожидания обработки. Проверьте библиотеку материалов позже',
        pollingFailed: 'Не удалось получить статус задачи. Проверьте библиотеку материалов позже',
        noTaskId: 'Обработка не выполнена: ID задачи не возвращён',
        loadMaterialFailed: 'Не удалось загрузить материалы',
        resultPromoted: 'Результат установлен как новое исходное изображение',
      },
    },
  },
};
