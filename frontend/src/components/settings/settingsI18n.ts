export const settingsI18n = {
  zh: {
    nav: { backToHome: '返回首页', backToTop: '返回顶部' },
    settings: {
      title: "系统设置",
      subtitle: "配置应用的各项参数",
      sections: {
  ...
  en: {
    nav: { backToHome: 'Back to Home', backToTop: 'Back to top' },
    settings: {
      title: "Settings",
  ...
  ru: {
    nav: { backToHome: "Вернуться на главную", backToTop: "Наверх" },
    settings: {
      title: "Настройки",
      ...
      fields: {
        ...
        imageQualityDesc: "Применяется только к моделям GPT Image (для DALL·E 3 сохраняется стандартное качество). Уровни xhigh и max требуют gpt-image-2.5 или более новой модели; для старых моделей используется high",
        imageQualityAuto: "Автоматически",
        imageQualityLow: "Низкое",
        imageQualityMedium: "Среднее",
        imageQualityHigh: "Высокое",
        imageQualityXhigh: "Очень высокое",
        imageQualityMax: "Максимальное",
      },
      apiKeyHelp: {
