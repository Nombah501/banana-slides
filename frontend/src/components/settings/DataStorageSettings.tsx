...
const dataStorageI18n = {
  ...
  ru: {
    dataStorage: {
      title: 'Расположение хранилища данных',
      description: 'Для хранения проектов, сгенерированных изображений, загруженных материалов и кэша экспорта.',
      pathLabel: 'Путь к хранилищу данных',
      browse: 'Выбрать',
      openCurrent: 'Открыть текущую папку',
      saveRestart: 'Сохранить и перезапустить',
      saving: 'Сохранение',
      loading: 'Загрузка расположения хранилища данных',
      loadFailed: 'Не удалось загрузить текущее расположение хранилища данных',
      inspectFailed: 'Не удалось использовать выбранную папку',
      openFailed: 'Не удалось открыть текущую папку данных',
      applyFailed: 'Не удалось сохранить расположение хранилища данных',
      pathRequired: 'Выберите или введите путь к хранилищу данных.',
      unchanged: 'Это расположение хранилища данных уже используется.',
      manualMigration: 'Приложение не перемещает и не удаляет существующие данные автоматически. Для миграции полностью выйдите из Banana Slides, затем целиком скопируйте data, uploads и exports из старой папки в новую.',
      restartHint: 'После изменения приложение немедленно перезапустится и будет читать данные из нового расположения. Обычные действия «Сохранить настройки» и «Восстановить значения по умолчанию» не изменяют этот путь.',
      confirmTitle: 'Использовать новое пустое расположение данных?',
      confirmBody: 'В выбранной папке отсутствует data/database.db. После переключения Banana Slides будет отображаться как новая установка. Существующие проекты останутся в старой папке и не будут перемещены или удалены.',
      confirmCheck: 'Подтверждаю, что при необходимости data, uploads и exports были скопированы, и понимаю, что в новой папке могут отсутствовать мои существующие проекты.',
      cancel: 'Отменить',
      confirmRestart: 'Подтвердить и перезапустить',
    },
  },
};
