...
const i18n = {
  ...
  ru: {
    ssm: {
      title: 'Переключить на единый шаблон',
      desc: 'Все страницы будут использовать один и тот же шаблон. Выберите существующий или загрузите новый.',
      styleLabel: 'Единое описание стиля (необязательно)',
      stylePlaceholder: 'Добавьте единое описание стиля для всех страниц…',
      uploadNew: 'Загрузить новый шаблон',
      uploading: 'Загрузка…',
      empty: 'Библиотека шаблонов пуста. Загрузите шаблон.',
      confirm: 'Подтвердить переключение',
      converting: 'Переключение…',
      cancel: 'Отменить',
      pickFirst: 'Сначала выберите или загрузите шаблон',
    },
  },
};
