...
const i18n = {
  ...
  ru: {
    ...
    ts: {
      ...
      back: 'Вернуться',
      next: 'Перейти к предварительному просмотру',
      toSingle: 'Переключить на единый шаблон',
      autoMatchAll: 'Автоматически сопоставить все',
      matching: 'Сопоставление…',
      library: 'Библиотека шаблонов проекта',
      pages: 'Страницы',
      uploadImage: 'Загрузить изображение',
      uploadPdf: 'Загрузить PDF',
      uploading: 'Загрузка…',
      pdfProcessing: 'Разбор PDF…',
      emptyLibrary: 'Библиотека пуста',
      emptyLibraryHint: 'Загрузите изображения шаблонов или целый PDF; после анализа для каждой страницы можно будет назначить шаблон',
      emptyPages: 'Страниц пока нет — сначала создайте их в редакторе структуры или описаний',
      labelPlaceholder: 'Добавить метку (необязательно)',
      delete: 'Удалить',
      reanalyze: 'Повторно проанализировать',
      expand: 'Развернуть анализ',
      collapse: 'Свернуть',
      statusPending: 'Выполняется анализ',
      statusProcessing: 'Выполняется анализ',
      statusCompleted: 'Анализ завершён',
      statusFailed: 'Не удалось выполнить анализ',
      pickTemplate: 'Выбрать шаблон',
      autoMatchPage: 'Автоматически сопоставить страницу',
      editStyle: 'Изменить текстовый шаблон',
      stylePlaceholder: 'Введите описание стиля текста для этой страницы…',
      saveStyle: 'Сохранить',
      unconfirmed: 'Не подтверждено',
      noDescHint: 'Для этой страницы отсутствует описание, автоматическое сопоставление невозможно',
      page: 'Страница {{num}}',
      currentStyle: 'Текстовый шаблон',
      confirmDelete: 'После удаления этого шаблона страницы, ссылающиеся на него, будут очищены. Продолжить?',
      confirmDeleteTitle: 'Подтвердить удаление шаблона',
      deletedCleared: 'Шаблон удалён; страниц сброшено: {{count}}',
      saved: 'Сохранено',
      matchDone: 'Автоматическое сопоставление завершено',
      pageMatchDone: 'Сопоставление страницы завершено',
      matchFailed: 'Не удалось выполнить автоматическое сопоставление',
      waitForPages: 'Страницы всё ещё создаются. Дождитесь завершения создания описаний страниц, прежде чем выполнять автоматическое сопоставление',
      waitForDescriptions: 'Сначала заполните описания всех страниц, затем выполните автоматическое сопоставление',
      waitForTemplates: 'Шаблоны всё ещё анализируются. Дождитесь завершения анализа всех шаблонов',
      needAnalyzedTemplate: 'Для автоматического сопоставления требуется хотя бы один успешно проанализированный шаблон',
      loading: 'Загрузка…',
      matchedOfTotal: 'Сопоставлено: {{matched}}/{{total}}',
      usedByPages: 'Используется на страницах: {{count}}',
      autoMatched: 'Сопоставлено автоматически',
      manualPicked: 'Выбрано вручную',
      templateRef: 'Шаблон №{{num}}',
    },
  },
};
